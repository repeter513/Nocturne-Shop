// Package postgres provides PostgreSQL connection pooling for the cart service.
// Пакет postgres предоставляет пул подключений PostgreSQL для сервиса корзины.
package postgres
